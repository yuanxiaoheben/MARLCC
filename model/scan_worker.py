...
class ScanModels(nn.Module):
    def __init__(self, configs):
        super(ScanModels, self).__init__()
        ...
        self.start_pn = policy_network(configs.n_hidden, configs.n_feature, configs.scan_n_action, configs.n_inter) 
        self.start_cn = critic_network(configs.n_hidden, 1)
        self.end_pn = policy_network(configs.n_hidden, configs.n_feature, configs.scan_n_action, configs.n_inter) 
